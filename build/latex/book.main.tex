...
\newcommand{\bookTitle}{Piccola Barca, Grande Montagna}
...
\input{./src-tex/frontmatter_intro.tex}

\chapter*{Prefazione}
\chaptermark{PREFAZIONE}
\addcontentsline{toc}{chapter}{Prefazione}
\input{./src-tex/frontmatter_preface.tex}

\chapter*{RINGRAZIAMENTI}
\chaptermark{RINGRAZIAMENTI}
\addcontentsline{toc}{chapter}{Ringraziamenti}
\input{./src-tex/ringraziamenti.tex}

\chapter*{ESSENZA DELLA MENTE}
\thispagestyle{empty}
\addcontentsline{toc}{chapter}{ESSENZA DELLA MENTE}

\chapter{REALT\`A ULTIMA E REALT\`A CONVENZIONALE}
\input{./src-tex/realita-ultima.tex}

\chapter{IL LUOGO DEL NON DIMORARE}
\input{./src-tex/il-luogo.tex}

\chapter*{ESSERE BUDDHA}
\thispagestyle{empty}
\addcontentsline{toc}{chapter}{ESSERE BUDDHA}

\chapter{LA VISIONE DELLA FORESTA}
\input{./src-tex/la-visione.tex}

\chapter{LA CESSAZIONE DELLA COSCIENZA}
\input{./src-tex/la-cessazione.tex}

\chapter{IMMANENTE E TRASCENDENTE}
\input{./src-tex/immanente-e-transcendente.tex}

\chapter*{CHI SEI?}
\thispagestyle{empty}
\addcontentsline{toc}{chapter}{CHI SEI?}

\chapter{NON C'\`E UN BUDDHA ALTROVE}
\input{./src-tex/non-ce-un-buddha-altrove.tex}

\chapter{SCENDERE DALLA RUOTA}
\input{./src-tex/scendere-dalla-routa.tex}

\chapter{IL RITIRO PORTATILE}
\input{./src-tex/il-ritiro-portatile.tex}

\addtocontents{toc}{\protect\clearpage}

\chapter*{CANTI SCELTI}
\chaptermark{CANTI SCELTI}
\addcontentsline{toc}{chapter}{Canti Scelti}
\input{./src-tex/canti-scelti.tex}

\chapter*{Glossario}
\chaptermark{GLOSSARIO}
\addcontentsline{toc}{chapter}{Glossario}
\input{./src-tex/glossary.tex}
